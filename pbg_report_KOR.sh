...
echo "├┼┼┼┼┼┼┼┼┤  3) Row Exclusive : DML" >> $LOG_DIR/pbg_lock${TODAY}.logecho "|2| | | | | | |X|X|   4) Share Update Exclusive : Vacuum, Analyze, Create index concurrently" >> $LOG_DIR/pbg_lock${TODAY}.log
...
echo "├┼┼┼┼┼┼┼┼┤  7) Exclusive : Parallel Process" >> $LOG_DIR/pbg_lock${TODAY}.logecho "|4| | | |X|X|X|X|X|   8) Access Exclusive : Alter, Drop, Truncate Table, Reindex, Cluster, Vacuum Full" >> $LOG_DIR/pbg_lock${TODAY}.log
echo "├┼┼┼┼┼┼┼┼┤" >> $LOG_DIR/pbg_lock${TODAY}.log
