...
echo "                                      # Slow QUERY REPORT #">> $LOG_DIR/pbg_slow2$TODAY.log
echo "-------┬-------------------┬----------------------┬-------------------------------------------------" >> $LOG_DIR/pbg_slow2$TODAY.log
echo " count | Time of occurrence| Query execution time |                    SLOW query" >> $LOG_DIR/pbg_slow2$TODAY.log
echo "-------┴-------------------┴----------------------┴-------------------------------------------------" >> $LOG_DIR/pbg_slow2$TODAY.log
...
rm -rf $LOG_DIR/pbg_slow$TODAY.log
mv $LOG_DIR/pbg_slow2$TODAY.log $LOG_DIR/pbg_slow$TODAY.log
